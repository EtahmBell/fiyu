...
/** 320ms apart: three arrivals rather than one staggered animation. */
const ARRIVAL_STEP_MS = 320;
  ...
  return (
    <section id="only-a-few" className="scroll-mt-24 border-b border-line bg-lavender-50/50">
      <div ref={ref} className={cn(LANDING_MEASURE, LANDING_RHYTHM)}>
         ...
         */}
        <div className="mx-auto mt-10 grid max-w-[62rem] gap-3 sm:mt-14 sm:grid-cols-3 sm:gap-5 lg:gap-7">
          {ONLY_A_FEW_EXAMPLES.map((example, index) => (
            <div key={example.id} className="min-w-0 border-b border-line-strong pb-3 sm:pb-4">
              <div
        ...
        <div
          aria-hidden="true"
          className="mx-auto mt-12 hidden max-w-[30rem] items-start sm:mt-16 sm:flex"
        >
